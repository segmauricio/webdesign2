...
$res=mostrarTodos($link);
 ?>
 <h3>Personas</h3> <a href="index.php?mod=new" class="btn btn-primary" disabled>Nuevo<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
